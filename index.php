      ...
      <section class="banner_main">
         <div class="container">
            <div class="row d_flex">
               <div class="col-md-5">
                  <div class="text-bg">
                     <h1>Hospedagem web<br> cheia de energia</h1>
      ...
      <div id="about" class="hosting">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                     <h2>O que há de novo na hospedagem na Web</h2>
                  </div>
               </div>
            </div>
            <div class="row">
      ...
      <div id="service" class="Services">
         <div class="container">
            ...
            <div class="row">
               ...
               <a class="read_more" href="#">Entrar em contato</a>
            </div>
         </div>
      </div>
      <!-- end Servicess -->
      ...
      <div id="why" class="why">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="titlepage">
                     <h2>Por que você deve escolher</h2>
                     <p>Lorem ipsum dolor sittem ametamngcing elit, persed do eiusmoad teimpor sittem elit inuning ut sed. </p>
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                  <div id="box_ho" class="why-box">
                     ...
                     <h3>Características poderosas</h3>
                     <p>Donec nec justo eget felis facilisis fermentum. Aliquam porttitor mauris sent amet orci.</p>
                  </div>
                  <a class="read_more bg" href="#">Leia mais</a>
               </div>
               <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                  <div class="why-box">
                     <i><img src="images/why2.png" alt="#" /></i>
                     <h3>Totaly Otimizado</h3>
                     <p>Donec nec justo eget felis facilisis fermentum. Aliquam porttitor mauris sent amet orci.</p>
                  </div>
                  <a class="read_more bg" href="#">Leia mais</a>
               </div>
         ...
         <div class="footer">
               ...
               <div class="row">
                  <div class="col-md-10 offset-md-1">
                     <div class="cont">
                        ...
                        <span>Lorem ipsum dolor sittem ametamngcing elit.</span>
            ...
            <div class="copyright">
               <div class="container">
                  <div class="row">
                     <div class="col-md-12">
                        <p>Todos os direitos reservados © 2021 <a href="#">Mazuco</a></p>
                     </div>
                  </div>
               </div>
            </div>
